...
public class CapturedRequest {
    ...
    private final ConnectionListenerAndFilter.AddressCheck filterResult;
    ...
    public CapturedRequest(String host, Integer port, ConnectionListenerAndFilter.AddressCheck filterResult, boolean isRuleMatched, boolean isDirectIpBlock, SocketAddress fromAddress) {
        this.host = host;
        this.port = port;
    ...
    public String getFilterResult() {
        return (filterResult == ConnectionListenerAndFilter.AddressCheck.CONNECTION_ALLOWED ? "Allowed" : "Prohibited")
